...
2. Hasil keluaran dari program **udpfileclient.py**, dari ip=192.168.0.119 menuju ip=192.168.0.112 dengan menggunakan port 5006, data yang dikirim yaitu **file 'bart.png'**
...
4. Hasil keluaran dari program **udp_simple.py** dari ip=192.168.0.119 menuju ip=192.168.0.112 dengan menggunakan port 5006, data yang dikirim yaitu **string berisi 'Progjar'**
